...
public class AST{
	...
	public static class void_const extends expression{
		public String value;
		public void_const(String v, int l){
			value = v;
			lineNo = l;
		}
		String getString(String space){
	...
	public static class attr extends feature {
		...
		public attr(String n, String t, expression v, int l){
			...
			value = v;
			lineNo = l;
			if(value == null  || value instanceof no_expr ) {
				if(typeid.equals("Int")) {
					value = new AST.int_const(0, lineNo);
				} else if(typeid.equals("String")){
					value = new AST.string_const("", lineNo);
				} else if(typeid.equals("Bool")) {
					value = new AST.bool_const(false, lineNo);
				} /*else {
					//value = new AST.void_const("void", lineNo);
					value = new AST.object("void", lineNo);
				}*/
			}
		}
